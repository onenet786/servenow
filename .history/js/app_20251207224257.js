            ...
            data.products.forEach(product => {
                ...
                productCard.innerHTML = `
                    <div class="product-image">
                        <img src="${imageSrc}" alt="${product.name}" loading="lazy" decoding="async" onerror="this.onerror=null;this.src='https://via.placeholder.com/200x150/E0E0E0/666666?text=No+Image'; console.warn('Product image failed to load:', '${product.id}', this.src)">
                    </div>
