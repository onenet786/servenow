        ...
        if (data.success) {
            ...
            data.products.forEach(product => {
                ...
                productCard.innerHTML = `
                    <img src="${imageSrc}" alt="${product.name}" onerror="this.onerror=null;this.src='https://via.placeholder.com/200x150/E0E0E0/666666?text=No+Image'; console.warn('Product image failed to load:', '${product.id}', this.src)">
