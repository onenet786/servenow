    ...
    storeProducts.forEach(product => {
        ...
        productCard.innerHTML = `
            ...
            <div class="product-card-content">
                ...
                <button class="add-to-cart" onclick="addToCart(${product.id}, '${product.name}', ${product.price}, ${Number.isFinite(parseInt(product.stock_quantity)) ? parseInt(product.stock_quantity,10) : 'undefined'}, '${String(product.unit_name || '').replace(/'/g, "\\'")}', ${product.unit_id || 'null'}, '${imageSrc.replace(/'/g, "\\'")}')">Add to Cart</button>
            </div>
        `;
