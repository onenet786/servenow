...
function loadDashboardStats() {
    ...
    .then(([orders]) => {
        ...
        if (el('todayPending')) el('todayPending').textContent = countStatus(todayOrders, 'pending');
        ...
        if (el('allPending')) el('allPending').textContent = countStatus(list, 'pending');
...
function loadOrders() {
    ...
    .then(data => {
        ...
        try {
            ...
            set('todayPending', countStatus(todayOrders, 'pending'));
            ...
            set('allPending', countStatus(currentOrders, 'pending'));
