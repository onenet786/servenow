...
async function showAddProductModal() {
    ...
    try {
        ...
        // Populate template-from-product dropdown and wire selection behavior
...
async function saveProduct() {
    ...
    const productData = {
        name: usingTemplate ? null : rawName,
        description: usingTemplate ? null : formData.get('description'),
        price: priceVal,
        category_id: formData.get('category_id') || null,
        store_id: storeId,
