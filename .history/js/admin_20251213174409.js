...
function initializeAdmin() {
    ...
    try {
        ...
        ensureModal('addUnitModal', 'addUnitForm', `\n            <label for="unitName">Name</label>\n            <input id="unitName" name="unit_name" required autocomplete="off" />\n            <label for="unitAbbrev">Abbreviation</label>\n            <input id="unitAbbrev" name="unit_abbreviation" autocomplete="off" />\n            <label for="unitMultiplier">Multiplier</label>\n            <input id="unitMultiplier" name="unit_multiplier" type="number" step="0.0001" value="1.0000" autocomplete="off" />\n        `, 'saveUnitBtn', 'Add / Edit Unit');
                ...
                <form id="addUnitForm" autocomplete="off">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="unitName" name="unit_name" required autocomplete="off" />
                        </div>
                        <div class="form-group">
                            <label for="unitAbbrev">Abbreviation:</label>
                            <input type="text" id="unitAbbrev" name="unit_abbreviation" autocomplete="off" />
                        </div>
                    </div>
                    <div class="form-row-full">
                        <div class="form-group">
                            <label for="unitMultiplier">Multiplier (relative):</label>
                            <input type="number" id="unitMultiplier" name="unit_multiplier" step="0.0001" value="1.0000" autocomplete="off" />
                        </div>
                    </div>
                    <div style="margin-top:0.75rem; display:flex; gap:0.5rem;">
...
async function saveUnit() {
    ...
    const nameInput = document.getElementById('unitName') || form.querySelector('#unitName');
    const abbrInput = document.getElementById('unitAbbrev') || form.querySelector('#unitAbbrev');
    const multInput = document.getElementById('unitMultiplier') || form.querySelector('#unitMultiplier');
    const payload = {
        name: nameInput && nameInput.value ? String(nameInput.value).trim() : '',
        abbreviation: abbrInput && abbrInput.value ? String(abbrInput.value).trim() : null,
        multiplier: multInput && multInput.value ? parseFloat(multInput.value) : 1.0
    };
    try {
