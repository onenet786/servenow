        ...
        row.innerHTML = `
            ...
            <td>
                <div class="action-buttons">
                    ...
                    <button class="btn-small btn-secondary" onclick="toggleProductStatus(${productId}, ${product.is_available})">
                        <i class="fas fa-${product.is_available ? 'ban' : 'check'}"></i> ${product.is_available ? 'Deactivate' : 'Activate'}
                    </button>
                </div>
            </td>
        `;
