...
function initializeAdmin() {
    ...
    document.getElementById('addUnitBtn').addEventListener('click', () => window.showAddUnitModal());
    document.getElementById('addSizeBtn').addEventListener('click', () => window.showAddSizeModal());
    ...
    if (addSizeBtn) addSizeBtn.addEventListener('click', () => window.showAddSizeModal());
