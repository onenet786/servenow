...
router.post('/', authenticateToken, requireAdmin, [
    ...
    try {
        ...
        const {
            firstName, lastName, email, phone, password, vehicleType, licenseNumber,
            fatherName, image_url, id_card_url, imageUrl, idCardUrl, idCardNum
        } = req.body;
        const imageUrlFinal = image_url || imageUrl || null;
        const idCardUrlFinal = id_card_url || idCardUrl || null;
        ...
        const [result] = await req.db.execute(insertSql, [
            ...
            fatherName || null, imageUrlFinal, idCardUrlFinal, idCardNum || null
        ]);
