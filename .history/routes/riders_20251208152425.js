...
router.get('/fuel-history', authenticateToken, requireAdmin, async (req, res) => {
    try {
        ...
        const [rows] = await req.db.execute(
            `SELECT fh.id, fh.rider_id, fh.fuel_date, fh.meter_reading, fh.petrol_rate, fh.petrol_qty, fh.cost, fh.notes, fh.created_at, fh.updated_at, r.first_name, r.last_name
...
router.get('/:id/fuel-history', authenticateToken, requireAdmin, async (req, res) => {
    try {
        ...
        const [rows] = await req.db.execute(
            `SELECT id, rider_id, fuel_date, meter_reading, petrol_rate, petrol_qty, cost, notes, created_at, updated_at
