...
Save the PRD into `d:\GIT-HUB\servenow\.zencoder\chats\0dad2b5a-0379-4eed-b6f7-a07510375959/requirements.md`.

### [ ] Step: Technical Specification

Based on the PRD in `d:\GIT-HUB\servenow\.zencoder\chats\0dad2b5a-0379-4eed-b6f7-a07510375959/requirements.md`, create a detailed technical specification to be used by a coding agent to implement the feature. Follow this template:
...
Save the spec to `d:\GIT-HUB\servenow\.zencoder\chats\0dad2b5a-0379-4eed-b6f7-a07510375959/spec.md`.

### [ ] Step: Implementation Plan

Based on the technical spec in `d:\GIT-HUB\servenow\.zencoder\chats\0dad2b5a-0379-4eed-b6f7-a07510375959/spec.md`, create a detailed task plan and update `d:\GIT-HUB\servenow\.zencoder\chats\0dad2b5a-0379-4eed-b6f7-a07510375959/plan.md`. Each task should have task definition, references to contracts to be used/implemented, deliverable definition and verification instructions.
